      ...
      body: Padding(
        ...
        child: Column(children: [
            ...
            child: Row(
              ...
              TextSpan(
                children: [
                  ...
                  TextSpan(text: 'Username / Password?',style: TextStyle(fontSize: 14,color: Colors.green)),
                ]
              )
            ),
            ],),
          ...
          TextButton(
            onPressed: () {}, 
            child: Text.rich(
              TextSpan(text: 'SIGN UP NOW',style: TextStyle(fontSize: 16,color: Colors.green))) 
            )
